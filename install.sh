...
c ""
c "Done. Try:"
c "   d4st detect app.example.com      # fingerprint + tell you what to run"
c "   d4st unauth app.example.com      # one-command external scan"
c "   d4st init --client Acme --target https://app.example.com   # guided authenticated setup"
c "   d4st serve                       # web console at http://localhost:8810"
c ""
c "Files land in $HOME_DIR (results/, sessions/, data/)."
