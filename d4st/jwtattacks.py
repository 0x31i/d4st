...
EHRM authenticates with a JWT in sessionStorage. The single highest-value active test for such an
...
_WEAK_SECRETS = [
    ...
    # EHRM/.NET-flavoured guesses (product/tenant words seen in the app)
    "ehrm", "ehrmsecret", "fhcsd", "fhc", "issuer", "audience", "IssuerSigningKey",
]
